...
class Dilithium:
    ...
    def _sample_mask_polynomial(self, rho_prime, i, kappa, is_ntt=False):
        ...
        mask = (1 << bit_count) - 1
        coeffs = [self.gamma_1 - ((r >> bit_count*i) & mask)
    ...
    def gen_public_key(self, sk_bytes):
        # unpack the secret key
        rho, K, tr, s1, s2, t0 = self._unpack_sk(sk_bytes)
        ...
        # Matrix multiplication
        t = (A @ s1.copy_to_ntt()).from_ntt() + s2
